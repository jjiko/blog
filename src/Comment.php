...
class Comment extends Model
{
  ...
  {
    return $this->belongsTo('Jiko\Blog\Post', 'comment_post_ID');
  }
  ...
  {
    return $this->belongsTo('Jiko\Blog\Comment', 'comment_parent');
  }
  ...
  {
    return $this->hasMany('Jiko\Blog\Comment', 'comment_parent');
  }
