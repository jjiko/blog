...
class Post extends Model
{
  ...
  {
    $this->connection = config('blog.connection');
  ...
  {
    return $this->hasMany('Jiko\Blog\PostMeta', 'post_id');
  }
  ...
  {
    return $this->hasOne('Jiko\Blog\ThumbnailMeta', 'post_id')
  ...
  {
    return $this->belongsToMany('Jiko\Blog\TermTaxonomy', 'term_relationships', 'object_id', 'term_taxonomy_id');
  }
  ...
  {
    return $this->hasMany('Jiko\Blog\Comment', 'comment_post_ID');
  }
  ...
  {
    return $this->belongsTo('Jiko\Blog\User', 'post_author');
  }

  /**
   * Parent post.
   *
   * @return Jiko\Blog\Post
   */
  public function parent()
  {
    return $this->belongsTo('Jiko\Blog\Post', 'post_parent');
  }
  ...
  {
    return $this->hasMany('Jiko\Blog\Post', 'post_parent')->where('post_type', 'attachment');
  }
  ...
  {
    return $this->hasMany('Jiko\Blog\Post', 'post_parent')->where('post_type', 'revision');
  }
